// lib/features/consultation/presentation/consultation_provider.dart
...
// ══════════════════════════════════════════════
// 3.  Coordinator Matches — FutureProvider.family
// ══════════════════════════════════════════════

final coordinatorMatchesProvider =
    FutureProvider.family<List<CoordinatorMatch>, int>((ref, requestId) async {
  final repo = ref.watch(consultationRepositoryProvider);
  return repo.getMatches(requestId);
});

// ══════════════════════════════════════════════
// 4.  Create Request — StateNotifier (form state)
// ══════════════════════════════════════════════
...
class CreateRequestState {
  ...
  // description is optional (can be empty), category + detail + period are required
  bool get isValid =>
...
final createConsultationProvider =
